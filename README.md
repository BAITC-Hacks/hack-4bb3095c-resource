...
**Тесты:** 27 автотестов · **Ключи для проверки не нужны**
...
1. **Все поставщики и склады компании** — схема данных уже поддерживает поставщиков, склады и клиентов; сроки поставки
   по фактическим документам поступления.
