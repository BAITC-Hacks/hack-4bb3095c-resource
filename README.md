...
лендинг. **Заранее подготовлено до 13:00:** только инфраструктурная обёртка LLM (`engine/llm.py`) и `AGENTS.md`
(правила для AI-агентов); вся функциональность кейса написана во время соревновательной части — см. историю коммитов.
