...
SYSTEM_PROMPT = (
    ...
    "Пиши для менеджера закупа: не упоминай технические имена полей (sku, reason, rec_qty, risk) — говори «код 1С», "
    "«обоснование», «к заказу», «риск дефицита»; числа — с пробелом между тысячами."
)
